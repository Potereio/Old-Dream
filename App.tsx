...
const primaryButtonClasses = "font-zhi-mang-xing text-3xl text-center text-black bg-yellow-400 py-3 px-8 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:-rotate-2 hover:bg-yellow-300 shadow-[2px_2px_0px_2px_rgba(0,0,0,0.2)]";
const secondaryButtonClasses = "font-zhi-mang-xing text-3xl text-center text-white bg-white/10 backdrop-blur-sm border-2 border-white/80 py-3 px-8 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:rotate-2 hover:bg-white hover:text-black";
...
function App() {
    ...
    const handleGenerateClick = async () => {
        ...
        const processDecade = async (decade: string) => {
            try {
                const prompt = `Reimagine the person in this photo in the style of the ${decade}. This includes clothing, hairstyle, and photo quality appropriate for the era. It is critical that you place them in a NEW and UNIQUE background that is highly characteristic of the ${decade}. Do not use a generic or repeated background. Also, ensure that besides the person, the main foreground elements (like objects, furniture, or props) are unique to this image and not repeated from other generated images. The output must be a photorealistic image showing the person clearly.`;
        ...
        <main className="bg-black text-neutral-200 min-h-screen w-full flex flex-col items-center justify-center p-4 pb-24 overflow-hidden relative">
            ...
            <div className="z-10 flex flex-col items-center justify-center w-full h-full flex-1 min-h-0">
                <div className="text-center mb-10">
                    <h1 className="text-7xl md:text-9xl font-zhi-mang-xing text-neutral-100">旧梦映像馆</h1>
                    <p className="font-zhi-mang-xing text-neutral-300 mt-4 text-3xl">穿梭时光，遇见旧我</p>
                </div>
