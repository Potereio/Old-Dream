                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    ...
                    <div className="flex items-center gap-4 sm:gap-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-zhi-mang-xing text-lg sm:text-xl text-center text-black bg-yellow-400 py-2 px-4 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:-rotate-2 hover:bg-yellow-300 shadow-[1px_1px_0px_1px_rgba(0,0,0,0.2)] whitespace-nowrap"
                        >
                            AI Studio 应用
                        </a>
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-zhi-mang-xing text-lg sm:text-xl text-center text-white bg-white/10 backdrop-blur-sm border border-white/50 py-2 px-4 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:rotate-2 hover:bg-white hover:text-black whitespace-nowrap"
                        >
                            与 Gemini 畅聊
                        </a>
                    </div>
